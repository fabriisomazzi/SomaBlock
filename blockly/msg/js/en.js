...
Blockly.Msg.ARD_ANALOGREAD = "leer el pin analógico";  // untranslated
Blockly.Msg.ARD_ANALOGREAD_TIP = "Valor de retorno entre 0 y 1024";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE = "establecer pin analógico#";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Escribe un valor analógico entre 0 y 255 en un puerto PWM específico";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED = "LED incorporado";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED_TIP = "Luz encendida o apagada para el LED incorporado del Arduino";  // untranslated
Blockly.Msg.ARD_COMPONENT_WARN1 = "¡Se debe agregar un bloque de configuración %1 con el mismo nombre %2 para usar este bloque!";  // untranslated
Blockly.Msg.ARD_DEFINE = "Define";  // untranslated
Blockly.Msg.ARD_DIGITALREAD = "leer pin digital#";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "Leer el valor digital en un pin: ALTO o BAJO";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "establecer pin digital#";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Escribe un valor digital ALTO o BAJO en un puerto específico";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "Bucle Arduino para siempre:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "Arduino se ejecuta primero:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "Define las funciones setup() y loop() de Arduino.";  // untranslated
Blockly.Msg.ARD_HIGH = "ALTO";  // untranslated
Blockly.Msg.ARD_HIGHLOW_TIP = "Establezca una lógica de estado de pin Alta o Baja.";  // untranslated
Blockly.Msg.ARD_LOW = "BAJO";  // untranslated
Blockly.Msg.ARD_MAP = "Mapa";  // untranslated
Blockly.Msg.ARD_MAP_TIP = "Reasigna un número de [0-1024] a otro.";  // untranslated
Blockly.Msg.ARD_MAP_VAL = "valor a [0-";  // untranslated
Blockly.Msg.ARD_NOTONE = "Desactivar el tono en el pin #";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN = "Sin PIN de tono#";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN_TIP = "Deja de generar un tono en un pin";  // untranslated
Blockly.Msg.ARD_NOTONE_TIP = "Apaga el tono en el pin seleccionado";  // untranslated
Blockly.Msg.ARD_PIN_WARN1 = "El pin %1 es necesario para %2 como pin %3. Ya se utiliza como %4.";  // untranslated
Blockly.Msg.ARD_PULSEON = "pulso en el pin#";  // untranslated
Blockly.Msg.ARD_PULSEREAD = "Leer";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT = "tiempo de espera después";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_MS = "";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "Mide la duración de un pulso en el pin seleccionado, si está dentro del tiempo de espera.";  // untranslated
Blockly.Msg.ARD_PULSE_TIP = "Mide la duración de un pulso en el pin seleccionado.";  // untranslated
Blockly.Msg.ARD_SERIAL_BPS = "bps";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT = "Imprimir";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "Agregar nueva Linea";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "Imprime datos en la consola/puerto serie como texto ASCII legible por humanos.";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "¡Se debe agregar un bloque de configuración para %1 al espacio de trabajo para usar este bloque!";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP = "Configuración";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Selecciona la velocidad para un periférico serial específico";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = ":  velocidad a";  // untranslated
Blockly.Msg.ARD_SERVO_READ = "leer SERVO desde PIN#";  // untranslated
Blockly.Msg.ARD_SERVO_READ_TIP = "Leer un ángulo de servo";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "Establecer SERVO desde el Pin";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "Grados (0~180)";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Establecer un servo en un ángulo específico";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "a";  // untranslated
Blockly.Msg.ARD_SETTONE = "Establecer tono en el pin #";  // untranslated
Blockly.Msg.ARD_SPI_SETUP = "Setup";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = "Configuración:";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "división del reloj";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPI modo (idle - edge)";  // untranslated
...
Blockly.Msg.ARD_STEPPER_COMPONENT = "paso a paso";  // untranslated
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MyStepper";  // untranslated
Blockly.Msg.ARD_STEPPER_MOTOR = "paso a paso motor:";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN1 = "pin1#";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "pin2#";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "¿Cuántos pasos por revolución?";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP = "Configurar el motor paso a paso";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "Configura la distribución de pines de un motor paso a paso y otras configuraciones.";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "establecer la velocidad (rpm) a";  // untranslated
...
Blockly.Msg.ARD_TIME_DELAY = "esperar";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microsegundos";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Esperar tiempo específico en milisegundos";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "Esperar tiempo específico en milisegundos";  // untranslated
Blockly.Msg.ARD_TIME_INF = "esperar para siempre (finalizar programa)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "Wait indefinitely, stopping the program.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "Tiempo transcurrido actual (microsegundos)";  // untranslated
...
Blockly.Msg.ARD_TIME_MILLIS = "Tiempo transcurrido actual (milisegundos)";  // untranslated
